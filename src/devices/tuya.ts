...
fingerprint: [
    ...
    exposes: [
        ...
        e.enum('leakage_current', ea.STATE, [])
            .withDescription('Leakage Current'),
        e.enum('forward_electricity', ea.STATE, [])
            .withDescription('Forward Electricity'),
        ...
        e
            ...
            .withValueStep(1)
            .withUnit('A')
            .withDescription('leakage threshold setting - USE WITH CAUTION - RISK LIFE !!'),
